...
DEFAULT_TARGET_LANGUAGE = "Central Kurdish"
...
translator = Translator(
    ...
    device=device,
    dtype=torch.float32  # Replace with the correct dtype based on the library's requirements
)
...
with gr.Blocks(css="style.css") as demo:
    ...
    with gr.Row(visible=False) as s2tt_example_row:
        s2tt_examples = gr.Examples(
            examples=[
                ["assets/sample_input.mp3", "Central Kurdish"],
                ["assets/sample_input.mp3", "Mandarin Chinese"],
                ["assets/sample_input_2.mp3", "Hindi"],
                ["assets/sample_input_2.mp3", "Spanish"],
            ],
